...
// hack: 添加一个自定义样式类
const _hoisted_2 = { key: 1, class: 'el-tooltip-content-wrap' };
          ...
          createVNode(ElTooltipContent, {
            ...
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "content", {}, () => [
                // hack: 将 span 改为 div, 便于支持样式设置
                _ctx.rawContent ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  innerHTML: _ctx.content
                  // hack: 将 span 改为 div, 便于支持样式设置
                }, null, 8, _hoisted_1)) : (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(_ctx.content), 1))
              ]),
